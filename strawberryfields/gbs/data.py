...
Using the :mod:`~.gbs.vibronic` module, GBS data has been generated by encoding a variety of
different molecules. The GBS samples can be used to recover the vibronic spectrum of the molecule.
