...
def read_gamess(file) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    ...
    This function extracts the atomic coordinates, atomic masses, vibrational frequencies,
    and normal modes of a molecule from the output file of a vibrational frequency calculation
    performed with the GAMESS quantum chemistry package.
